...
class __TwigTemplate_50ecf6101cb96ef53ded00dd35dce34d916854276fc5e2faf39fb462d5472c5c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/explore_zymphonies_theme/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\drupal\\themes\\explore_zymphonies_theme\\templates\\content-edit\\filter-tips.html.twig");
    }
